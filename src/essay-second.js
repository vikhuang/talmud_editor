...
export const Essay3 = (props) => {
    const onFocusedBoolean = (props.onFocused === 3);
    return(
        <div className='essay3'>
            <div className='essay3_block_right'></div>
              <Editor essayNo='Essay Part3' onFocused={onFocusedBoolean}/>  
        </div>
    );
}

export const Essay4 = (props) => {
    const onFocusedBoolean = (props.onFocused === 4);
    return(
        <div className='essay3'>
            <div className='essay3_block_left'></div>
                <Editor essayNo='Essay Part4' onFocused={onFocusedBoolean}/> 
        </div>
    );
}
